...
u16 model_data_active_1[8] = {
		0xA120, 0xB720, 0xB8B0, 0xBA80,
		0xBBC0, 0xBC90, 0xBD50, 0xBF00
};
u16 model_data_active_2[8] = {
		0xC020, 0xC1C0, 0xC440, 0xC8B0,
		0xCC60, 0xCE90, 0xD240, 0xD820
};
u16 model_data_active_3[8] = {
		0x0160, 0x26C0, 0x1A00, 0x1EC0,
		0x4440, 0x4800, 0x2060, 0x3240
};
u16 model_data_active_4[8] = {
		0x1DE0, 0x0F60, 0x14C0, 0x0D80,
		0x1460, 0x0C00, 0x1000, 0x1000
};
...
#elif defined(CONFIG_MACH_CHAGALL_KDI)
	if ((read_soc[1] >= 0xF1) && (read_soc[1] <= 0xF3)) {
#endif
