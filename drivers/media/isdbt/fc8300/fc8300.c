...
int isdbt_hw_setting(void)
{
	...
	gpio_direction_output(isdbt_pdata->gpio_tmm_sw, 1); //by default Antenna is set
#endif
...
static DEVICE_ATTR(isdbt_signal_source, (S_IRUSR | S_IRGRP | S_IWUSR | S_IWGRP), isdbt_signal_source_show, isdbt_signal_source_store);
#endif
